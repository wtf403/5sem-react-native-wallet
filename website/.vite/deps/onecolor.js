...
var require_color = __commonJS({
  "node_modules/onecolor/lib/color.js"(exports, module) {
    ...
    var cssColorRegExp = new RegExp(
      "^(rgb|hsl|hsv)a?\\(" + channelRegExp.source + "[, ]" + channelRegExp.source + "[, ]" + channelRegExp.source + "(?:[,/]" + channelRegExp.source + ")?\\)$",
      "i"
    );
    ...
    function color(obj) {
      if (Array.isArray(obj)) {
        ...
        if (matchCssSyntax) {
          ...
          let alpha = undef(matchCssSyntax[8]) ? 1 : void 0;
          if (alpha === void 0) {
            if (matchCssSyntax[9] === "%") {
    ...
    color.installColorSpace = function(colorSpaceName, propertyNames, config) {
        ...
        propertyNames.forEach(function(propertyName2, i) {
          ...
          if (propertyName2 === "alpha") {
            ...
            if (isNaN(propertyValue)) {
              throw new Error(
                "[" + colorSpaceName + "]: Invalid color: (" + propertyNames.join(",") + ")"
              );
            }
      ...
      prototype.toJSON = function() {
        return [colorSpaceName].concat(
          propertyNames.map(function(propertyName2) {
      ...
      function installForeignMethods(targetColorSpaceName, sourceColorSpaceName) {
        ...
        color[sourceColorSpaceName].propertyNames.forEach(function(propertyName2) {
          ...
          obj[propertyName2] = obj[shortName] = function(value, isDelta) {
            return this[sourceColorSpaceName.toLowerCase()]()[propertyName2](
              value,
              isDelta
            );
          };
        ...
        for (var prop in obj) {
          if (Object.prototype.hasOwnProperty.call(obj, prop) && color[targetColorSpaceName].prototype[prop] === void 0) {
  ...
  "node_modules/onecolor/lib/plugins/toAlpha.js"(exports, module) {
    module.exports = function toAlpha(color) {
      color.installMethod("toAlpha", function(color2) {
        var me = this.rgb();
        var other = color2(color2).rgb();
        var epsilon = 1e-10;
        var a = new color2.RGB(0, 0, 0, me._alpha);
